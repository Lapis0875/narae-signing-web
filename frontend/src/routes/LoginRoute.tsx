  ...
  return (
    <AppShell>
      <section className="app-panel login-panel">
        <h1>관리자 로그인</h1>
        {sessionExpired ? (
          <p role="alert">세션이 만료되었습니다. 다시 로그인해 주세요.</p>
        ) : null}
        <form
        ...
        >
          ...
          <button
            ...
            disabled={isSubmitting || remainingLockoutMinutes !== null}
            type="submit"
          >
        ...
        {failureMessage === null ? null : (
          <p role="alert">
            ...
            {remainingLockoutMinutes === null
              ? null
              : ` ${remainingLockoutMinutes}분 후 다시 시도해 주세요.`}
          </p>
        )}
      </section>
    </AppShell>
