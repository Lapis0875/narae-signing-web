...
interface BoardAdminFacade {
    ...
    BoardView rename(BoardOwner owner, UUID boardId, String title);
    Slot updateSlot(BoardOwner owner, UUID boardId, UUID slotId, SlotBounds bounds, SlotBackground background);
