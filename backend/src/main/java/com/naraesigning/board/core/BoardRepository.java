...
record StoredBoard(
    ...
    StoredBoard withTitle(BoardTitle changedTitle) {
        return new StoredBoard(id, owner, changedTitle, status, canvasWidth, canvasHeight,
                share, createdAt, updatedAt);
    }

    StoredBoard withShare(StoredShare changedShare) {
        return new StoredBoard(id, owner, title, status, canvasWidth, canvasHeight,
                changedShare, createdAt, updatedAt);
    }

    StoredBoard withStatus(BoardStatus changedStatus) {
        return new StoredBoard(id, owner, title, changedStatus, canvasWidth, canvasHeight,
                share, createdAt, updatedAt);
    }
}
